...
const BLOG = {
      ...
      NOTION_PAGE_ID:
            process.env.NOTION_PAGE_ID || '6de0133d85194c45abb31d29b81a83aa',
      ...
      GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是康师傅, Hi，我是一个气氛组,Hi，让我们一起来学习 AI & Web3, 欢迎来到我的博客🎉',
    
      CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。
    
      AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '康师傅', // 您的昵称 例如 
      BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的人🍚', // 作者简介
      LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.chefkang.xyz', // 网站地址
      KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'web3,ai,sharing', // 网站关键词 英文逗号隔开
    
      // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
      CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@.com
      ...
      POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,facebook,twitter,messenger,line,whatsapp', // 分享的服務，按顺序显示,逗号隔开
      ...
      // 谷歌广告
      ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'pub-9490487841529174', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
      ...
      ADSENSE_GOOGLE_SLOT_IN_ARTICLE: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '4837783381', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
      ADSENSE_GOOGLE_SLOT_FLOW: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '7543289033', // Google AdScene>广告>按单元广告>新建信息流广告
      ADSENSE_GOOGLE_SLOT_NATIVE: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_NATIVE || '9140275885', // Google AdScene>广告>按单元广告>新建原生广告
      ADSENSE_GOOGLE_SLOT_AUTO: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '5795641830', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
      ...
      TITLE: process.env.NEXT_PUBLIC_TITLE || 'Chef Kang Space', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
      HOME_BANNER_IMAGE:
            process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
      DESCRIPTION:
            process.env.NEXT_PUBLIC_DESCRIPTION || '了解更多 AI WEB3 的信息分享', // 站点描述，被notion中的页面描述覆盖
